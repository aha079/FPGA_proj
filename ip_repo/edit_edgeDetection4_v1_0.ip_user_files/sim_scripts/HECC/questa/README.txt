...
#
# Generated by export_simulation on Sun Jul 11 16:51:19 +0430 2021
#
################################################################################
...
'-reset_run' switch to the './HECC.sh' script.
...
./HECC.sh -noclean_files

For more information on the script, please type './HECC.sh -help'.
